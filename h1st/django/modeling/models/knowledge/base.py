...
class KnowledgeModel(H1stModel):
    """Knowledge Model."""

    class Meta(H1stModel.Meta):
        """Metadata."""

        verbose_name: str = 'H1st Knowledge Model'
        verbose_name_plural: str = 'H1st Knowledge Models'
        ...
        default_related_name: str = 'h1st_knowledge_models'
