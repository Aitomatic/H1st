...
class PreTrainedHuggingFaceTokenClassifier(PreTrainedHuggingFaceTransformer):
    ...
    def predict(self,
            ...
            -> Union[TokenClassificationOutputType,
                     List[TokenClassificationOutputType]]:
    ...
    def gradio_ui(cls) -> Interface:
        return Interface(
            ...
            outputs=JSONOutputComponent(label='Recognized Tokens'),
...
# alias
H1stPreTrainedHuggingFaceTokenClassifier = PreTrainedHuggingFaceTokenClassifier
